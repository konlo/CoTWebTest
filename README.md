...
FastAPI 기반 CoT Prompt Lab입니다. IMS 번호별 JSON 데이터를 묶어 프롬프트를 수정하고, 렌더링하고, OpenAI 호환 API(기본: 로컬 Ollama `qwen3:8b`)로 바로 테스트할 수 있습니다.
...
- `LLM_PROVIDER=ollama` 설정 시 로컬 Ollama(`qwen3:8b`)를 OpenAI 호환 Chat Completions로 호출
